...
<main class="l-main" id="main">
	<section class="p-home__main---wrapper">
		<div class="p-home__main">
			<figure id="ViewIn"><div><img src="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph001.jpg" alt="" width="928" height="696"></div></figure>
	...
	<section class="p-home__lead">
		<div class="p-home__lead---flx">
			<figure class="p-home__lead---flx____ph" id="ViewIn"><picture><source media="(min-width: 619px)" srcset="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph002.jpg"><img src="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph008.jpg" width="544" height="724"></picture></figure>
	...
	<div class="p-home__strength">
		...
		<div class="p-home__strength---list">
			<div class="p-home__strength---list____block">
				...
				<figure id="ViewIn"><img src="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph003.jpg" alt="" width="256" height="256"></figure>
			</div>
			<div class="p-home__strength---list____block">
				<h3>量産力</h3>
				<p>充実した最新機械設備を使用して、迅速かつ高い量産性を発揮します。<br>細心の衛生管理のもとに、効率的な生産を目指しています。</p>
				<figure id="ViewIn"><img src="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph004.jpg" alt="" width="256" height="256"></figure>
			</div>
			<div class="p-home__strength---list____block">
				<h3>提案力</h3>
				<p>お客様のニーズにお応えし、お役に立てる商品をご提案いたします。伝統を踏まえつつ、次代に向けた食文化の提案を発信してまいります。</p>
				<figure id="ViewIn"><img src="<?php bloginfo('template_url') ?>/assets/img/dummy/top/ph005.jpg" alt="" width="256" height="256"></figure>
			</div>
		</div>
	</div>
