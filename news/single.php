		...
		<div class="p-text-box">
			<div class="wp-pager">
				<ul>
					...
					if($prev) {
						echo '<li class="prev"><a rel="prev" aria-label="前のページ" href="'.get_permalink($prev).'"><span>前へ</span></a></li>';
					}
					?>
					<li class="center"><a href="<?php echo home_url('/news'); ?>">一覧を見る</a></li>
					<?php
					$next = get_adjacent_post(false,'',false);
					if($next) {
						echo '<li class="next"><a rel="next" aria-label="次のページ" href="'.get_permalink($next).'"><span>次へ</span></a></li>';
					}
					?>
				</ul>
			</div>
