		...
		<div class="p-header__nav-container">
			<nav class="p-header__nav">
				<ul class="p-header__nav-list nav-list01">
					...
					<li class="p-header__nav-item p-header__nav-item02"><a href="<?php echo home_url('/product'); ?>" class="a-effect<?php if(is_post_type_archive('product') || is_tax('product_cat') || is_singular('product')): ?> a-active<?php endif; ?>">商品紹介</a></li>
