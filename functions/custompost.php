...
function create_post_type()
{
    ...
    //products 商品のご案内　カスタム投稿タイプを追加 //////////////////////////////////////////////////////////////////
    register_post_type(
        'products', // 投稿タイプ名(スラッグ)
        array(
            'labels' => array(
                'name' => __('商品のご案内'), // 投稿タイプ名(表示名)
                'singular_name' => __('商品のご案内') // 投稿タイプ名(表示名)
            ),
            'menu_icon' => 'dashicons-clipboard',
            'public' => true,
            'menu_position' => 5,
    ...
    register_taxonomy(
        ...
        array(
            'hierarchical' => true,
            'update_count_callback' => '_update_post_term_count',
            'label' => '商品のご案内のカテゴリ', // タクソノミー名（表示名）
            'singular_label' => '商品のご案内のカテゴリ', // タクソノミー名（表示名）
            'public' => true,
            'show_ui' => true,
            'show_in_rest' => true,
            'rewrite' => array(
